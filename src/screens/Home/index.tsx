...
import { Container, Scroller, Title, Subtitle, ListContainer, AddButtonContainer, AddButton, AddButtonText } from './styles';
    ...
    <Container>
      <Scroller refreshControl={
        ...
        <Header>
          ...
          <Subtitle>Ultima atualização: 10/04/2002 14:50</Subtitle>
        </Header>
        <ListContainer>
